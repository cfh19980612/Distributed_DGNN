...
class node_partition_balance():
    ...
    def workload_partition(self):
        ...
        workloads_GCN, workloads_RNN = workload_balance(self.P_id, self.P_workload, self.P_snapshot, self.Q_id, self.Q_node_id, self.Q_workload, self.timesteps, self.num_devices)
